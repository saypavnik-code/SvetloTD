...
export const WAVES: WaveData[] = [
  ...
  { wave:17, enemyType:'nether_drake',  count:1,  interval:0,   hpMult:1.0, paths:0,  isBoss:true,  modifier:null,      bonusGold:90,  preview:'💀 БОСС: Нефритовый Дракон' },
  { wave:18, enemyType:'phantom',       count:20, interval:0.4, hpMult:2.5, paths:-1, isBoss:false, modifier:'fast',    bonusGold:80,  preview:'👁 Рой Призраков!' },
