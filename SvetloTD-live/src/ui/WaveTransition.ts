...
export class WaveTransition {
  ...
  private _sub!:   Phaser.GameObjects.Text;
  private _bar!:   Phaser.GameObjects.Graphics;
  private _barFill!: Phaser.GameObjects.Graphics;
  private _timer   = 0;
  ...
  private _onWaveStarted = (waveNumber: unknown): void => {
    const n = waveNumber as number;
