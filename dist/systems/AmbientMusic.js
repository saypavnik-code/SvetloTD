...
export class AmbientMusic {
    constructor(musicGainNode) {
        ...
        // ── Timer state ─────────────────────────────────────────────────────────────
        Object.defineProperty(this, "_arpTimer", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 2.0
        }); // seconds until next arp note
        Object.defineProperty(this, "_padTimer", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 15.0
        }); // seconds until next pad note change
        Object.defineProperty(this, "_lastArpIdx", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: -1
        ...
        // ── Note tables ─────────────────────────────────────────────────────────────
        // PAD: C3  D3     F3     G3
        Object.defineProperty(this, "PAD_NOTES", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: [130.81, 146.83, 174.61, 196.00]
        });
        // ARP: C4    D4     E4     G4    A4
        Object.defineProperty(this, "ARP_NOTES", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: [261.63, 293.66, 329.63, 392.00, 440.00]
        });
        ...
        // PAD
        Object.defineProperty(this, "_padOsc1", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "_padOsc2", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "_padGain", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        // ARP shared FX chain
        Object.defineProperty(this, "_arpFilter", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "_arpDelay", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "_arpFb", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "_arpOut", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        // SEA
        Object.defineProperty(this, "_seaSrc", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "_seaFilter", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "_seaGain", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "_lfoOsc", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "_lfoGain", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        this.ctx = musicGainNode.context;
    ...
    stop(durationMs = 2000) {
        ...
        try {
            this._padOsc1.stop(stopAt);
        }
        catch { /* already stopped */ }
        try {
            this._padOsc2.stop(stopAt);
        }
        catch { /* already stopped */ }
        try {
            this._seaSrc.stop(stopAt);
        }
        catch { /* already stopped */ }
        try {
            this._lfoOsc.stop(stopAt);
        }
        catch { /* already stopped */ }
    }
    /**
