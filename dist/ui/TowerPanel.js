...
import { TOWER_DEFS, BUILDABLE_TOWER_IDS } from '../data/towers';
import { TargetPriority } from '../entities/Tower';
import { GAME_WIDTH, GAME_HEIGHT, GRID_COLS, TILE_SIZE, COLORS, DEPTH, FONT_FAMILY, } from '../config';
...
export class TowerPanel {
    constructor(scene, build, economy) {
        ...
        // ── Build panel ───────────────────────────────────────────────────────────
        Object.defineProperty(this, "_buildRoot", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "_rowBgs", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        });
        Object.defineProperty(this, "_selBars", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        });
        Object.defineProperty(this, "_rowNameTxts", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        });
        Object.defineProperty(this, "_rowCostTxts", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        ...
        // ── Info panel ────────────────────────────────────────────────────────────
        Object.defineProperty(this, "_infoRoot", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "_infoTitle", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "_infoLevel", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "_infoSwatch", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "_statLines", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        });
        Object.defineProperty(this, "_liveStatLines", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        });
        Object.defineProperty(this, "_prioLabel", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "_upgBtns", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        });
        Object.defineProperty(this, "_sellGfx", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "_sellLbl", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "_sellZone", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "_statsTimer", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
        ...
        // ── Tooltip ───────────────────────────────────────────────────────────────
        Object.defineProperty(this, "_ttRoot", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "_ttBg", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "_ttTexts", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        });
        Object.defineProperty(this, "_ttTimer", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        });
        Object.defineProperty(this, "_ttVisible", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: false
        });
        Object.defineProperty(this, "_tower", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        });
        Object.defineProperty(this, "_selectedIdx", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: -1
    ...
    _buildPanelBackground() {
        ...
        g.fillStyle(COLORS.bgDark, 0.35);
        g.fillRect(PX + 6, 0, 8, GAME_HEIGHT);
        g.lineStyle(4, COLORS.walnutDark, 0.95);
        g.strokeRect(PX, 0, PW, GAME_HEIGHT);
        g.lineStyle(2, COLORS.amberDeep, 0.75);
        g.strokeRect(PX + 4, 4, PW - 8, GAME_HEIGHT - 8);
        g.lineStyle(3, COLORS.walnutDark, 0.9);
        g.beginPath();
        g.moveTo(PX, 0);
        g.lineTo(PX, GAME_HEIGHT);
        g.strokePath();
        g.lineStyle(1, COLORS.amberDeep, 0.85);
        g.beginPath();
        g.moveTo(PX + 2, 0);
        g.lineTo(PX + 2, GAME_HEIGHT);
        g.strokePath();
    }
    // ── Build panel ───────────────────────────────────────────────────────────
    _buildBuildPanel() {
        ...
        divG.beginPath();
        divG.moveTo(PX + PAD, titleY + 22);
        divG.lineTo(PX + PW - PAD, titleY + 22);
        divG.strokePath();
        ...
        BUILDABLE_TOWER_IDS.forEach((id, i) => {
            ...
            rowBg.fillStyle(COLORS.bgPanelHover, 0.95);
            rowBg.fillRoundedRect(rx + 6, ry + 3, PW - 12, ROW_H - 6, 6);
            rowBg.lineStyle(1, COLORS.amberDeep, 0.55);
            rowBg.strokeRoundedRect(rx + 6, ry + 3, PW - 12, ROW_H - 6, 6);
            this._buildRoot.add(rowBg);
            ...
            selBar.fillRoundedRect(PX + 8, ry + 6, 5, ROW_H - 12, 2);
            this._buildRoot.add(selBar);
            this._selBars.push(selBar);
            // Hotkey box
            const hkG = s.add.graphics().setDepth(DEPTH.PANEL + 2);
            hkG.fillStyle(COLORS.bgDark, 0.5);
            hkG.fillRoundedRect(PX + PAD, ry + 14, 22, 22, 3);
            hkG.lineStyle(1, COLORS.walnutLight, 0.7);
            hkG.strokeRoundedRect(PX + PAD, ry + 14, 22, 22, 3);
            ...
            swG.fillStyle(COLORS.walnutDark, 0.9);
            swG.fillRoundedRect(PX + PAD + 30, ry + 18, 14, 14, 2);
            swG.fillStyle(data.color, 0.95);
            swG.fillRoundedRect(PX + PAD + 32, ry + 20, 10, 10, 2);
            ...
            this._buildRoot.add(nameTxt);
            this._rowNameTxts.push(nameTxt);
            // Subtitle
            ...
            this._buildRoot.add(costTxt);
            this._rowCostTxts.push(costTxt);
            // Interactive zone
    ...
    _buildInfoPanel() {
        ...
        div.beginPath();
        div.moveTo(PX + PAD, iy + 24);
        div.lineTo(PX + PW - PAD, iy + 24);
        div.strokePath();
        ...
        div2.beginPath();
        div2.moveTo(PX + PAD, statY0 + 6 * 20 + 4);
        div2.lineTo(PX + PW - PAD, statY0 + 6 * 20 + 4);
        div2.strokePath();
        ...
        for (let i = 0; i < 2; i++) {
            ...
            this._infoRoot.add(ugfx);
            this._infoRoot.add(ulbl);
            this._infoRoot.add(uzone);
    ...
    _populateInfo(tower) {
        ...
        const specialLabel = (() => {
            if (data.special.length === 0)
                return data.splash > 0 ? `AoE ${data.splash}px` : '—';
    ...
    _redrawSellBtn(tower) {
        if (!tower)
            return;
        const sellY = GAME_HEIGHT - 80 - 44;
        const sellW = PW - PAD * 2;
        this._sellGfx.clear();
        this._sellGfx.fillStyle(COLORS.bgDark, 0.45);
        this._sellGfx.fillRoundedRect(PX + PAD, sellY, sellW, 36, 6);
        this._sellGfx.lineStyle(2, COLORS.dangerSoft, 0.75);
        this._sellGfx.strokeRoundedRect(PX + PAD, sellY, sellW, 36, 6);
    ...
    _buildTooltip() {
        ...
        for (let i = 0; i < 8; i++) {
            ...
            this._ttRoot.add(t);
            this._ttTexts.push(t);
        }
    }
    _showTooltip(id, panelX, rowY) {
        if (this._ttTimer)
            this._ttTimer.remove();
        this._ttTimer = this._scene.time.delayedCall(400, () => {
            const data = TOWER_DEFS[id];
            const TW = 220, TH = 144, tx = panelX - TW - 8, ty = Math.min(rowY, GAME_HEIGHT - TH - 8);
            this._ttBg.clear();
            this._ttBg.fillStyle(COLORS.bgDark, 0.97);
            this._ttBg.fillRoundedRect(tx, ty, TW, TH, 6);
            this._ttBg.lineStyle(2, COLORS.walnutLight, 0.75);
            this._ttBg.strokeRoundedRect(tx, ty, TW, TH, 6);
            this._ttBg.lineStyle(1, COLORS.amberDeep, 0.9);
            this._ttBg.strokeRoundedRect(tx + 3, ty + 3, TW - 6, TH - 6, 4);
            const lines = [
            ...
            this._ttTexts.forEach((t, i) => {
                ...
                if (!l)
                    return;
                t.setText(l.text);
                t.setColor(l.color || COLORS.bgPrimary_css);
                if (l.size)
                    t.setFontSize(l.size);
                t.setPosition(tx + 10, ty + 8 + i * 16);
            });
            this._ttRoot.setVisible(true);
    ...
    update(_delta) {
        ...
        if (this._tower && this._infoRoot.visible) {
            ...
            if (this._statsTimer >= 1000) {
                this._statsTimer = 0;
                this._liveStatLines[0]?.setText(this._tower.totalDamageDealt.toLocaleString('ru-RU'));
